...
public class ContainerReporter extends Thread {
  ...
  public ContainerReporter(ApplicationContainerProtocol protocol, Configuration conf,
                           AnecYarnContainerId anecyarnContainerId, String anecyarnCmdProcessId) {
    this.protocol = protocol;
    this.conf = conf;
    this.containerId = anecyarnContainerId;
    this.anecyarnCmdProcessId = anecyarnCmdProcessId;
  ...
  public void run() {
    try {
      produceCpuMetrics(this.anecyarnCmdProcessId);
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  private void produceCpuMetrics(String anecyarnCmdProcessId) throws IOException {
    String command = "cat /proc/" + anecyarnCmdProcessId + "/stat";
    try {
