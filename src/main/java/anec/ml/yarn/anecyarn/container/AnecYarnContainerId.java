...
public class AnecYarnContainerId implements Writable {

  private ContainerId containerId;

  public AnecYarnContainerId() {
    this.containerId = null;
  }

  public AnecYarnContainerId(ContainerId id) {
    this.containerId = id;
  }
  ...
  public boolean equals(Object obj) {
    AnecYarnContainerId other = (AnecYarnContainerId) obj;
