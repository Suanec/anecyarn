...
public class HistoryClientService extends AbstractService {
  ...
  protected void serviceStart() throws Exception {
    ...
    InetSocketAddress address = conf.getSocketAddr(
        ...
        AnecYarnConfiguration.ANECYARN_HISTORY_ADDRESS,
    ...
    server =
        rpc.getServer(HSClientProtocol.class, protocolHandler, address,
            ...
            conf.getInt(AnecYarnConfiguration.ANECYARN_HISTORY_CLIENT_THREAD_COUNT,
                AnecYarnConfiguration.DEFAULT_ANECYARN_HISTORY_CLIENT_THREAD_COUNT));
    ...
    server.start();
    this.bindAddress = conf.updateConnectAddr(AnecYarnConfiguration.ANECYARN_HISTORY_BIND_HOST,
        AnecYarnConfiguration.ANECYARN_HISTORY_ADDRESS,
        conf.get(AnecYarnConfiguration.ANECYARN_HISTORY_ADDRESS, AnecYarnConfiguration.DEFAULT_ANECYARN_HISTORY_ADDRESS),
  ...
  protected void initializeWebApp(Configuration conf) {
    ...
    InetSocketAddress bindAddress = AnecYarnWebAppUtil.getJHSWebBindAddress(conf);
    // NOTE: there should be a .at(InetSocketAddress)

    try {
      Method webAppBuild = WebApps.Builder.class.getMethod("build", WebApp.class);
      webAppBuild.invoke(WebApps.$for("jobhistory", HistoryClientService.class, this, "ws").with(conf).withHttpSpnegoKeytabKey(AnecYarnConfiguration.ANECYARN_WEBAPP_SPNEGO_KEYTAB_FILE_KEY).withHttpSpnegoPrincipalKey(AnecYarnConfiguration.ANECYARN_WEBAPP_SPNEGO_USER_NAME_KEY).at(NetUtils.getHostPortString(bindAddress)), webApp);
      ...
      WebApps
          ...
          .withHttpSpnegoKeytabKey(
              AnecYarnConfiguration.ANECYARN_WEBAPP_SPNEGO_KEYTAB_FILE_KEY)
          .withHttpSpnegoPrincipalKey(
              AnecYarnConfiguration.ANECYARN_WEBAPP_SPNEGO_USER_NAME_KEY)
    ...
    String connectHost = AnecYarnWebAppUtil.getJHSWebappURLWithoutScheme(conf).split(":")[0];
    AnecYarnWebAppUtil.setJHSWebappURLWithoutScheme(conf,
