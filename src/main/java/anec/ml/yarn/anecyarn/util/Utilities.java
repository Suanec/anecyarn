package anec.ml.yarn.anecyarn.util;
...
public final class Utilities {
  ...
  public static Path getRemotePath(AnecYarnConfiguration conf, ApplicationId appId, String fileName) {
    String pathSuffix = appId.toString() + "/" + fileName;
    Path remotePath = new Path(conf.get(AnecYarnConfiguration.ANECYARN_STAGING_DIR, AnecYarnConfiguration.DEFAULT_ANECYARN_STAGING_DIR),
        pathSuffix);
